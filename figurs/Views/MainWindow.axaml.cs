        ...
        private void OnPointerPressed(object? sender, PointerPressedEventArgs e)
        {
            ...
            else
            {
                string shapeName = _draggedShape is Rectangle ? "квадрат" :
                                   ...
                                   _draggedShape is Polygon polygon ? (polygon.Points.Count == 3 ? "треугольник" :
                                   polygon.Points.Count == 5 ? "пятиугольник" :
                                   polygon.Points.Count == 6 ? "шестиугольник" :
                                   polygon.Points.Count == 7 ? "семиугольник" : "восьмиугольник") :
                                   "фигуру";
